...
function descargarPDF() {
  ...
  const opt = {
    margin: [10, 10, 10, 10], // Márgenes ajustados para que haya espacio en los bordes
    filename: `Proforma_${alumnoSafe}.pdf`,  // Nombre del archivo con el alumno
    image: { type: 'jpeg', quality: 0.98 },  // Control de calidad de las imágenes
    html2canvas: { 
      scale: 1,  // Reducir la escala para que se ajuste el contenido
      useCORS: true, // Permite cargar imágenes desde dominios externos
      logging: true, // Activar los logs para depurar si es necesario
      x: 0,   // Ajustes adicionales si la imagen está desplazada
      y: 0, 
    },
    jsPDF: { 
      unit: 'mm', 
  ...
  // Renderizar el PDF con las opciones configuradas
